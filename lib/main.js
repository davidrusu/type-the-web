...
let button = buttons.ActionButton({
    ...
    onClick: () => {
        ...
        let greetingPanel = panel.Panel({
            ...
            contentURL: data.url("greeting/greeting.html")
        });
        greetingPanel.show();

        let worker = tab.attach({
            contentScriptFile: [ data.url("./libs/jquery-2.1.1.min.js"),
                                 data.url("./libs/ramda-0.8.0.min.js"),
                                 data.url("./constants/constants.js"),
                                 data.url("./constants/nonstandard-char-map.js"),
                                 data.url("./constants/replace-map.js"),
